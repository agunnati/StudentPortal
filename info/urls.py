...
urlpatterns = [
    ...
    path('student/<slug:class_id>/sem1', views.sem1, name='sem1'),
    path('student/<slug:class_id>/sem2', views.sem2, name='sem2'),
    path('student/<slug:class_id>/sem3', views.sem3, name='sem3'),
    path('student/<slug:class_id>/sem4', views.sem4, name='sem4'),
    path('student/<slug:class_id>/sem5', views.sem5, name='sem5'),
