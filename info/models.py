...
test_name = (
    ...
    ('Semester Mid Exam', 'Semester Mid Exam'),
...
class Student(models.Model):
    ...
    EID = models.CharField(primary_key='True', max_length=100)
    name = models.CharField(max_length=200)
    sex = models.CharField(max_length=50, choices=sex_choice, default='Male')
    DOB = models.DateField(default='1998-01-01')
    email = models.CharField(max_length=50, default='college@gmail.com')
    a_email = models.CharField(max_length=50, default='personal@gmail.com')
...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='10:00 - 11:00')
...
class Attendance(models.Model):
    ...
    date = models.DateField(default='2020-01-08')
...
class AttendanceTotal(models.Model):
    ...
    def classes_to_attend(self):
        ...
        total_class = Attendance.objects.filter(course=cr, student=stud).count()
        att_class = Attendance.objects.filter(course=cr, student=stud, status='True').count()
        cta = math.ceil((0.85*total_class - att_class)/0.15)
        if cta < 0:
            return 0
        return cta
...
class MarksClass(models.Model):
    assign = models.ForeignKey(Assign, on_delete=models.CASCADE)
    name = models.CharField(max_length=50, choices=test_name, default='Internal test')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Internal test')
                    sc.marks_set.create(name='Semester Mid Exam')
